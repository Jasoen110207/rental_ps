...
<link href="https://fonts.googleapis.com/css2?family=Chivo:wght@400;500;600;700;900&amp;family=Space+Grotesk:wght@500;600;700;800&amp;family=Space+Mono:wght@400;700&amp;display=swap" rel="stylesheet">
...
<body class="bg-[#F0F2FA] text-on-surface font-body-md min-h-screen antialiased flex justify-center selection:bg-secondary-container selection:text-surface-container-lowest">
@yield('content')
